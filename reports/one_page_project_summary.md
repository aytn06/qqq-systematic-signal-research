...
Daily QQQ close/high/low data plus cross-asset features such as DXY. The public repo includes only synthetic sample data. Actual research data should be stored locally and documented in `data/README.md`.
